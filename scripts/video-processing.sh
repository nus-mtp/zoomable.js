...
_360p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -r 30 -vf scale=480x360 -x264opts bframes=0:keyint_min=250 -movflags +faststart -preset slow -profile:v baseline -level 3.0 -an ${parentdir}${slash}${vidname}${_360p_ext}${finalformat}
}
...
_480p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -r 30 -vf scale=640x480 -x264opts bframes=0:keyint_min=250 -movflags +faststart -preset slow -profile:v baseline -level 3.0 -an ${parentdir}${slash}${vidname}${_480p_ext}${finalformat}
}
...
_720p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -r 30 -vf scale=1280x720 -x264opts bframes=0:keyint_min=250 -movflags +faststart -preset slow -profile:v baseline -level 3.0 -an ${parentdir}${slash}${vidname}${_720p_ext}${finalformat}
}
...
_1080p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -r 30 -vf scale=1920x1080 -x264opts bframes=0:keyint_min=250 -movflags +faststart -preset slow -profile:v baseline -level 3.0 -an ${parentdir}${slash}${vidname}${_1080p_ext}${finalformat}
}
