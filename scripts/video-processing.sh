...
_360p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -crf 23 -vf scale=-1:360 -x264opts keyint=48:min-keyint=48:no-scenecut -movflags +faststart -preset slow -profile:v high -an ${parentdir}${slash}${vidname}${_360p_ext}${finalformat}
}
...
_480p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -crf 23 -vf scale=-1:480 -x264opts keyint=48:min-keyint=48:no-scenecut -movflags +faststart -preset slow -profile:v high -an ${parentdir}${slash}${vidname}${_480p_ext}${finalformat}
}
...
_720p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -crf 23 -vf scale=-1:720 -x264opts keyint=48:min-keyint=48:no-scenecut -movflags +faststart -preset slow -profile:v high -an ${parentdir}${slash}${vidname}${_720p_ext}${finalformat}
}
...
_1080p_cmd() {
	ffmpeg -i ${parentdir}${slash}${vidname_and_ext} -c:v libx264 -crf 23 -vf scale=-1:1080 -x264opts keyint=48:min-keyint=48:no-scenecut -movflags +faststart -preset slow -profile:v high -an ${parentdir}${slash}${vidname}${_1080p_ext}${finalformat}
}
